...
export ZSH="/home/barba/.oh-my-zsh"
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting web-search colorize nvm npm pip python pyenv)
...
export FZF_CTRL_R_OPTS="--preview 'echo {}' --preview-window down:5"
